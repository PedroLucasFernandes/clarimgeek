    ...
    return(
        <div class={styles.subColumn}>
            ...
            <div class={styles.videosContainer}>
                <iframe width="336" height="189" src="https://www.youtube.com/embed/ntr4fHIE1s0" frameborder="0" allowfullscreen></iframe>
                <iframe width="336" height="189" src="https://www.youtube.com/embed/wBfWLwp15Ak" frameborder="0" allowfullscreen></iframe>
                <iframe width="336" height="189" src="https://www.youtube.com/embed/tGWlSQKPMsA" frameborder="0" allowfullscreen></iframe>
